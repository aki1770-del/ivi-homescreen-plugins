...
.
        ...
        ##Functional Test Case
            ...
            https
    :  // github.com/toyota-connected/tcna-packages/tree/main/packages/camera/camera_linux/example
...
``` / dev /
        media0[] : Failed to open media device at / dev /
                   media0
    : Permission denied
```
