...
4. Within the copied binary distribution, delete the tests/ directory, as well as the packaged Angle libraries in the
   debug and release directories: libEGL.so, libGLESv2.so, libvk_swiftshader.so, libvulkan.so.1
