...
using PigeonFullMetaData = InternalFullMetaData;
using PigeonListOptions = InternalListOptions;
using PigeonListResult = InternalListResult;
using PigeonSettableMetadata = InternalSettableMetadata;
using PigeonStorageFirebaseApp = InternalStorageFirebaseApp;
using PigeonStorageReference = InternalStorageReference;
enum class InternalStorageTaskState;
using PigeonStorageTaskState = InternalStorageTaskState;
...
class FirebaseStorageHostApi {
 public:
  ...
  virtual void ReferencePutData(
      ...
      const InternalSettableMetadata& settable_meta_data,
      int64_t handle,
      std::function<void(ErrorOr<std::string> reply)> result) = 0;
