...
const std::string& InternalStorageReference::bucket() const {
  return bucket_;
}
...
const std::string& InternalStorageReference::name() const {
  return name_;
}
...
int64_t InternalListOptions::max_results() const {
  return max_results_;
}
...
size_t PigeonInternalDeepHash(const InternalListOptions& v) {
  return v.Hash();
}
...
const EncodableList& InternalListResult::items() const {
  return items_;
}
...
const EncodableList& InternalListResult::prefixs() const {
  return prefixs_;
}
...
size_t PigeonInternalDeepHash(const InternalListResult& v) {
  return v.Hash();
}
