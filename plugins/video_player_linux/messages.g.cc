...
// `binary_messenger`.
void LinuxVideoPlayerApi::SetUp(flutter::BinaryMessenger* binary_messenger,
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const int64_t track_index_arg =
                  encodable_track_index_arg.LongValue();
              std::optional<FlutterError> output =
                  api->SetAudioTrack(texture_id_arg, track_index_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              std::optional<FlutterError> output =
                  api->SetOutputChannels(texture_id_arg, channels_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              std::optional<FlutterError> output =
                  api->SetMute(texture_id_arg, mute_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              std::optional<FlutterError> output =
                  api->SetScaleMethod(texture_id_arg, method_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              std::optional<FlutterError> output =
                  api->SetAVOffset(texture_id_arg, offset_ms_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              std::optional<FlutterError> output =
                  api->SetSubtitlesEnabled(texture_id_arg, enabled_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
          ...
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const int64_t texture_id_arg =
                  encodable_texture_id_arg.LongValue();
              ErrorOr<int64_t> output =
                  api->GetSubtitleTrackCount(texture_id_arg);
              if (output.has_error()) {
                reply(WrapError(output.error()));
                return;
              }
          ...
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const int64_t track_index_arg =
                  encodable_track_index_arg.LongValue();
              std::optional<FlutterError> output =
                  api->SetSubtitleTrack(texture_id_arg, track_index_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              std::optional<FlutterError> output =
                  api->SetSubtitleUri(texture_id_arg, uri_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const auto& font_desc_arg =
                  std::get<std::string>(encodable_font_desc_arg);
              std::optional<FlutterError> output =
                  api->SetSubtitleFont(texture_id_arg, font_desc_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const auto& preset_arg =
                  std::get<std::string>(encodable_preset_arg);
              std::optional<FlutterError> output =
                  api->SetChannelMixPreset(texture_id_arg, preset_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const auto& bands_arg =
                  std::get<EncodableList>(encodable_bands_arg);
              std::optional<FlutterError> output =
                  api->SetEqualizer(texture_id_arg, bands_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const auto& brightness_arg =
                  std::get<double>(encodable_brightness_arg);
              ...
              const auto& contrast_arg =
                  std::get<double>(encodable_contrast_arg);
              ...
              const auto& saturation_arg =
                  std::get<double>(encodable_saturation_arg);
              ...
              std::optional<FlutterError> output =
                  api->SetVideoBalance(texture_id_arg, brightness_arg,
                                       contrast_arg, saturation_arg, hue_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const auto& enabled_arg = std::get<bool>(encodable_enabled_arg);
              std::optional<FlutterError> output =
                  api->SetAudioPassthrough(texture_id_arg, enabled_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
      ...
      channel->SetMessageHandler(
          [api](const EncodableValue& message,
            ...
            try {
              ...
              const int64_t in_channels_arg =
                  encodable_in_channels_arg.LongValue();
              ...
              const int64_t out_channels_arg =
                  encodable_out_channels_arg.LongValue();
              const auto& encodable_matrix_arg = args.at(3);
              if (encodable_matrix_arg.IsNull()) {
                reply(WrapError("matrix_arg unexpectedly null."));
                return;
              }
              const auto& matrix_arg =
                  std::get<EncodableList>(encodable_matrix_arg);
              std::optional<FlutterError> output =
                  api->SetChannelMixMatrix(texture_id_arg, in_channels_arg,
                                           out_channels_arg, matrix_arg);
              if (output.has_value()) {
                reply(WrapError(output.value()));
                return;
              }
