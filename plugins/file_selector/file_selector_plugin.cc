...
ErrorOr<flutter::EncodableList> FileSelectorPlugin::ShowFileChooser(
  ...
  if (options.current_folder_path()) {
    ihs::log::debug("[file_selector] Current Folder Path: {}",
    ...
    ihs::log::debug("[file_selector] No Current Folder Path specified");
  }
